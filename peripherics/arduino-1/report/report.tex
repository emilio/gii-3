...
Dio tiempo a hacer el circuito detector de la temperatura usando el sensor
\texttt{TMP 36}.


\subsection{Funcionamiento del circuito}

El circuito es directo, y sólo necesita el sensor. El sensor es un componente
curioso. Es un RTD o \textit{Resistance Temperature Detector}
(\cite{web:wikipedia-rtd}).
...
El circuito fue directo de implementar. La conversión de entrada analógica a
temperatura está en la función \texttt{temperature}.
