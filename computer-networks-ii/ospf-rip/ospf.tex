...
qué routers son vecinos o similar\footnote{Lo siento, tenía que dejar
  esto aquí: https://www.youtube.com/watch?v=aPtr43KHBGk}, y en R1 ya
constaba la conexión directa con esas tres redes.
...
inmediatamente\footnote{¿Es en cuanto realiza R1 el ack del LS Update de
  R2? Es lo que parece, ya que se ven un par de paquetes lanzados hacia
  R5 tras el LS ack de R1, pero podría ser que R1 tardara en re-evaluar
  las rutas.}.
